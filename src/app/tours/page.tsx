...
export default function ToursPage() {
  ...
  const buildTourWhatsAppLink = (title: string, slug?: string) => {
    const urlPart = slug ? ` ${website}/tours/${slug}` : '';
    const text = `Hi, I want to enquire about the tour package: ${title}.${urlPart}`;
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Filters */}
      <ToursFilter tours={tourPackages} />
                ...
                <div key={tour.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow">
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      ...
                      <a
                        href={buildTourWhatsAppLink(tour.title, tour.slug)}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-green-600 hover:bg-green-700 text-white text-center text-sm py-2 rounded-lg font-semibold transition-colors"
                      >
                        WhatsApp
                      </a>
                    </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-3">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-12 h-11 rounded-lg bg-green-600 hover:bg-green-700 transition-colors flex items-center justify-center"
                        aria-label={`WhatsApp enquiry for ${tour.title}`}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-amber-600 to-orange-600 rounded-2xl p-8 md:p-12 text-white text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <a 
                  href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent('Hi, I want to book a tour package from Mysore')}`}
                  target="_blank"
                  rel="noopener noreferrer"
